...
import { setLocales } from '../reducers/locales';
...
class FileHashRouter extends HashRouter {
    ...
    onpathchange () {
        ...
        if ("/" in pathName || pathName === "" || pathName === this.playerPath) {
            // 直接设置编辑器状态并更新URL，无需刷新页面
            this.onSetIsPlayerOnly(false);
            this.onSetIsFullScreen(false);
            history.replaceState(null, null, this.editorPath);
